...
/**
 * x/html tags used by this helper.
 *
 * @var array
 * @access public
 */
...
/**
 * x/html tags used by the helper
 *
 * @var array
 * @access public
 */
...
/**
 * Sets up the correct X/HTML tags
 *
 * @return void
 * @access public
 */
	function __construct($settings = array()) {
		...
		if (isset($this->__docTypeMap[$docType])) {
			$this->tags = $this->__tags[$this->__docTypeMap[$docType]];
			$this->docType = $docType;
		} else {
			$this->tags = $this->__tags[$this->__docTypeMap['xhtml-strict']];
 ...
 */
	function docType($type = 'xhtml-strict') {
		...
		if (isset($this->__docTypes[$type])) {
			...
			return $this->__docTypes[$this->docType];
		}
		return null;
	}
/**
